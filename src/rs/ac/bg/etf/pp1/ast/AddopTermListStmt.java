...
public class AddopTermListStmt extends AddopTermList {

    private AddopTermList AddopTermList;
    private Addop Addop;
    private Term Term;

    public AddopTermListStmt (AddopTermList AddopTermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermListStmt(\n");
